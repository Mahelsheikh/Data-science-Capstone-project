...
ui<-dashboardPage(
        ...
        dashboardBody(
                ...
                tabItem(tabName = "documentation",
                        h3("Instructions:"),
                        br(),
                        h3("Type in the sentence to get the prediction"),
                        br(),
                        h3("Note: If there are 2 instances have the same predicted word it might look like the application is not responsive."),
                        br(),
                        h3("The following links has detailed steps to produce this data product:",
                           br(),
